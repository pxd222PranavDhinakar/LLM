...
HYPERPARAMETERS = {
    ...
    'batch_size': 32,
    'num_epochs': 10,
    'learning_rate': 0.0001,  # Reduced from 0.001 for decoder stability
...
class AdditionDataset(Dataset):
    def __init__(self, max_length, num_samples):
        ...
        self.max_seq_length = (max_length * 2) + 3  # 2 numbers + operators + possible carry
        ...
        for i in range(1, self.max_length + 1):
            for j in range(1, self.max_length + 1):
                for _ in range(samples_per_combination):
                    ...
                    # For decoder: input includes part of target for teacher forcing
                    input_tokens = self.tokenize(input_str + target_str[:-1])
...
def main():
    ...
    print("\n" + "="*50)
    print("ARITHMETIC DECODER TRAINING")
    print("="*50)
